...
SRC_PATH = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..', 'pdf', 'utils'))
DST_PATH = os.path.join(os.path.dirname(__file__), 'pdf', 'utils')
...
def main():
    print('Creating ~~utils~~ source distribution')
